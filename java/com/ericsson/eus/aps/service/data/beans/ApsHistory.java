...
public class ApsHistory implements Serializable {
	
	private static final long serialVersionUID = -5187277597187708607L;
	...
	public String toString() {
		return "ApsHistory [pdofLast4= ****" + ", recurringTopupCycleCode=" + recurringTopupCycleCode
